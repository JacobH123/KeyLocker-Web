...
export function Header({ toggleSidebar }) {
  ...
  const [notification, setNotification] = useState(null);  // added 'notification'
  ...
  return (
    <>
      {/* Notification Toast */}
      {notification && (
        <div className="fixed top-20 right-6 bg-red-600 text-white px-6 py-3 rounded-lg shadow-lg flex items-center gap-2 z-50">
          {notification}
        </div>
      )}
